...
for L2=12:16
    for ratio=Ratio
        ...
        LoadFolder='InitialState_MediumSystem_ValenceStoichiometry/';
...
if rep==1
fprintf(fid, ['dump 1 all movie ' num2str(TimeRecordInterval) ' Out_Anneal/' OutFilename '.mpeg type type zoom 4.5 box yes 0.01 view 85 85 size 1000 400 shiny 0.5\n']);
